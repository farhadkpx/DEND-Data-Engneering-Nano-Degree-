...
#-------------------------- US_Cities_Temperature ------------------------------
    dim_US_City_Temperature_insert = ("""
          ...
          INNER JOIN Fact_Immigration_Table ft ON uc.City_Port = ft.Port_Code
          INNER JOIN Fact_Immigration_Table fk ON uc.Port_States = fk.Current_State
...
#-------------------US_City_Demog_Race-------------------------------
    dim_US_City_Demog_Race_insert = ("""
         SELECT
          ...
          INNER JOIN  Fact_Immigration_Table ft ON cd.Demog_Port = ft.Port_Code
          INNER JOIN  Fact_Immigration_Table fp ON cd.Port_States = fp.Current_State
""")
