...
#================================ Processing all the data files and sending output to a workspace folder ===============
...
def Immigration_data_processing(spark, output_data):
    """
       ...
       Arguments:
            ...
            input_data: Reading from workspace Source.
...
def Airports_data_processing(spark, output_data):
    """
       ...
       I'll write it as a parquet file back to workspace/S3 bucket folder.
    
       Arguments:
       Spark: SparkSession object as ceated.
       Input_data: Sourcing from workspace.
       Output_data: Path location of processed table either Workspace or S3 bucket.
       Returns: None    
    """
...
def Processing_label_descriptions_file(spark, output_data):
    """ 
       ...
       Arguments:
            ...
            input_data: input source of data table (workspace source used).
            output_data: Path location of processed table either Workspace or S3 bucket.
       Returns: None
    """
...
def Temperature_data_processing(spark,  output_data):
    """ 
       ...
       Arguments:
            Spark: SparkSession object.
            Input_data: Input source of Temperature table(Workspace source).
            Output_data: Path location of processed table either Workspace or S3 bucket.
       Returns: None
    """
...
def Processing_US_demography_data(spark, output_data):
    """
       ...
       Arguments:
            Spark: SparkSession object
            Input_data: Source of input data (Workspace here)
            Output_data: Path location of processed table either Workspace or S3 bucket.
       Returns: None
    """
